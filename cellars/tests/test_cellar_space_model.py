...
class TestCellarSpaceModel(TestCase):
    ...
    def test_constraint__error__same_row_and_column_same_cellar(self):
        cellar = factory.create_cellar({"layout": [5, 6, 6, 6, 6], "user": self.seeds.users[0]})
    ...
    def test_constraint__ok__same_row_and_column_different_cellar(self):
        _cellar = factory.create_cellar({"layout": [5, 6, 6, 6, 6], "user": self.seeds.users[0]})
        _another_cellar = factory.create_cellar({"layout": [5, 6, 6, 6, 6], "user": self.seeds.users[0]})
